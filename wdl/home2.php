...
// REGISTER USER
$sql = "INSERT INTO commenttable (fname, lname, comment)
           ...
           <span class="navbar-toggler-icon"> </span>
            ...
            <div class="collapse navbar-collapse text-center" id="collapsenavbar">
              ...
              <ul class="navbar-nav ml-auto ">
                ...
                <li class="nav-item">
                  <a href="#contacts" class="nav-link text-white">Feedbback</a>
                </li>
				<li class="nav-item">
...
GROCERY 1O1 targets revenue of 1CR in the next year</p></div><a href="https://retail.economictimes.indiatimes.com/news/food-entertainment/grocery" class="a1">Click here to know more...</a><hr>
<div class="transbox">
<p>
<u>HT Times</u></br>
GROCERY 1O1 secret to superior quality products</p></div><a href="https://retail.economictimes.indiatimes.com/news/food-entertainment/grocery" class="a1">Click here to know more...</a><hr><hr>
<div class="transbox"><p><u>
Reuter's</u></br>
GROCERY 1O1 is set to create an organic revolution in India</p></div><a href="https://retail.economictimes.indiatimes.com/news/food-entertainment/grocery" class="a1">Click here to know more...</a><hr><hr>  
</section>
<br>
<br>
<br>
...
<br>
 ...
 <section id="contacts">
  ...
  <div class="row">
    <div class="column">
      <img src="https://insights.retailenvironments.org/wp-content/uploads/2014/06/019327-green-metallic-orb-icon-symbols-shapes-comment-bubble2.png" style="width:70% ;margin-left:14%">
    </div>
    <div class="column">
      <form method="POST" action="home1.php" name="adminform" onsubmit="return validateform()">
...
<div id="table-container" class="bgimg3" ><br> <button id="showData" class="btn" style="float:right ; width:100% ;font-size:xx-large;">Show Comments</button><br>
